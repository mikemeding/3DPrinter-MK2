...
#define CUSTOM_MACHINE_NAME "MK2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // MK2 PID tune 210 degrees 8 cycles
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // My MK2 printer (60 degrees for 8 cycles)
  #define DEFAULT_bedKp 113.25
  #define DEFAULT_bedKi 15.39
  #define DEFAULT_bedKd 555.69
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 367 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 10, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 1, 0 }
